#===============================================================================
#04 classes 16批量生成骨架的测地线距离和连接关系
#===============================================================================
getwd()
...
#----01 获得图片列表和输入输出路径
dir<-"F:/DataSet_From_Web/GWAS_plant_type/GWAS_result_image/classes12/ok"
filelist<-list.files(dir,pattern = ".png")
outdir<-"F:/DataSet_From_Web/GWAS_plant_type/GWAS_result_GB_distances/classes12"

# dir0<-"D:/GWAS_plant_type/GWAS_result_image/T16/problem/ok/png"
# filelist0<-list.files(dir0,pattern = ".png")
# filelist<-c("P0919_14.png")
#----02 分析代码
for (i in 1:length(filelist)) {
  # i<-1
  filename<-filelist[i]#"P0761_16.png"#
  #判断是否存在文件夹
