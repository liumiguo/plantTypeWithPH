...
#设置路径并获得文件夹列表
dir<-"F:/DataSet_From_Web/GWAS_plant_type/GWAS_result_GB_distances/classes12/"
...
#导出数据(过滤后的)
# write_rds(list_filter,"./data/T16_PH_data/GWAS_classes12_PH_data_filter.rds")


#绘图
feature.matrix<-list_filter$P0394_12
x.min <- 0
