#===================================================================
#07 classes 16 构建Bottleneck distance矩阵
#===================================================================
...
datalist<-read_rds("./data/T16_PH_data/GWAS_classes12_PH_data_filter.rds")
...
# write_rds(re_mat,"./data/T16_PH_data/GWAS_classes12_BottleneckDistance_matrix.rds")
